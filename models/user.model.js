...
const User = mongoose.model(
    ...
    new mongoose.Schema({
        ...
        district: { type: 'string', require: false, null: true, default: null },
        city: { type: 'string', require: false, null: true, default: null },
        lang: { type: 'string', require: false, null: true, default: null },
        notify: { type: 'boolean', require: false, null: true, default: null },
        position: { type: 'boolean', require: false, null: true, default: null  },
